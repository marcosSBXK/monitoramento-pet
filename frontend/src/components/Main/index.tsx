            ...
            <main id="main">
                ...
                <section id="resume" className="resume">
                    <div className="container">
                        ...
                        <div className="section-title">
                            <h2>Resumo</h2>
                            <p>Concentre seu tempo no caso clínico e deixe o gerenciamento das informações por conta do BichanoVet. Cadastre tutor e seu animal, comece um atendimento, inclua resultados de exames, marque um retorno.</p>
                        </div>
                        ...
                        <div className="row">
                            <div className="col-lg-6" data-aos="fade-up">
                                ...
                                <div className="resume-item pb-0">
                                    <h4>Acessivel</h4>
                                    <p><em>"Com nossos sistemas, o gerenciemento de seus clientes, dos dados e das informações será de facil acesso e ágil."</em></p>
                                ...
                                <div className="resume-item">
                                    ...
                                    <p>O BichanoVet é um portal de conteúdo para os clientes que buscam está antenados sobre a medicina veterinária e profissionais da area que buscam se aprimorar. Os assuntos são diversos como, alimentação, moda entre outros.</p>
                ...
                <section id="portfolio" className="portfolio section-bg">
                    <div className="container">
                        ...
                        <div className="section-title">
                            ...
                            <p>Aqui, o cliente cadastrado pode inserir dados pertinentes a sua mascote. Nome, idade, peso, uma foto dele bem caprichada e também pode receber atualizações sobre vacinação, alimentação mais adequada a ela. São informações que farão seu bichano ter qualidade de vida.</p>
                        </div>
                        ...
                        <div className="row" data-aos="fade-up">
                            <div className="col-lg-12 d-flex justify-content-center">
                                <ul id="portfolio-flters">
                                    ...
                                    <li data-filter=".filter-app">Alimentação</li>
                                    <li data-filter=".filter-card">Vacinas</li>
                ...
                <section id="serviços" className="services">
                    <div className="container">
                        ...
                        <div className="section-title">
                            <h2>Serviços</h2>
                            <p>Prezamos muito pela qualidade de vida e saúde do seu pet e através da linha do tempo, desde a sua adoção ou nascimento, podemos monitorar toda a rotina facilitando a troca de todas as informações possíveis em relação a ele, onde donos, tutores, médicos veterinários e PetShops terão acesso. </p>
                        </div>
                        ...
                        <div className="row">
                            <div className="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
                                ...
                                <p className="description">Prezamos muito pela qualidade de vida e saúde do seu pet e através da linha do tempo, desde a sua adoção ou nascimento, podemos monitorar toda a rotina facilitando a troca de todas as informações possíveis em relação a ele, onde donos, tutores, médicos veterinários e PetShops terão acesso. </p>
                            </div>
                            ...
                            <div className="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <p className="description">Este sistema será gerenciado por um pet shop e será desenvolvido semanalmente, relatórios sobre cuidados ao pet, horários de passeios, alimentação adequada, alerta para aplicações de vacinas, possíveis surtos de doenças e cuidados em geral.</p>
                            </div>
                            <div className="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="200">
                                <div className="icon"><GiEarthAmerica /></div>
                                <h4 className="title"><a>MODA PET - BEM ESTAR DO BICHANO</a></h4>
                                <p className="description">O sistema também dará dicas sobre moda, cuidados em relação ao clima, se tem necessidade de utilizar roupinhas e até mesmo calçados, como meias e etc.</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="testimonials" className="testimonials section-bg">
                    <div className="container">
                        ...
                        <div className="section-title">
                            <h2>Quem Somos</h2>
                            <p>Somos um grupo de alunos fatecanos, que trabalhamos comprometidos com o aprimoramento de nossas competências, para elaborar esse sistema.</p>
                        </div>
                            ...
                            <div className="col-lg-30">
                                <OwlCarousel className='' >
                                    ...
                                    <div className="testimonial-item" data-aos="fade-up" data-aos-delay="300">
                                        <p>
                                            <i className="bxs-quote-alt-left"></i>
                                            <i>"Bichano Vet"</i> foi uma forma de ajudar tanto tutores quanto veterinários e donos de <i>pet shop</i> a darem qualidade de vida a todos os tipos de animais de estimação. É um serviço feito para que donos dêem o máximo de informação aos médicos e donos de lojas de animais sobre a rotina de seus bichanos e, ao mesmo tempo, quem cuida da saúde das mascotes pode trazer informações adicionais que resultem em uma vida mais saudável ao animalzinho.
                                            <i className="bxs-quote-alt-right"></i>
                                        </p>
                                        <img src={testimonials_4} className="testimonial-img" alt=""></img>
                                        <h3>Marcos Vinicios da Silva</h3>
                                        <h4>Desenvolvedor de Software & Estudante</h4>
                                    </div>
                ...
                <section id="contact" className="contact">
                    <div className="container">
                        ...
                        <div className="section-title">
                            <h2>Contato</h2>
                            <p>Tire suas dúvidas, faça sugestões, elogios, críticas ao "BichanoVet". Sua participação é imprescindível para que a gente possa aprimorar o que estamos fazendo com bastante carinho e atenção em favor dos <i>pets</i> e de seus tutores.</p>
                        </div>
                        ...
                        <div className="row" data-aos="fade-in">
                            ...
                            <div className="col-lg-5 d-flex align-items-stretch">
                                <div className="info">
                                    ...
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12097.433213460943!2d-74.0062269!3d40.7101282!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xb89d1fe6bc499443!2sDowntown+Conference+Center!5e0!3m2!1smk!2sbg!4v1539943755621" frameBorder="0" className="border:0; width: 100%; height: 290px;" allowFullScreen></iframe>
                                </div>
                            ...
                            <div className="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
                                <form action="forms/contact.php" method="post" role="form" className="php-email-form">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <textarea className="form-control" name="message" data-rule="required" data-msg="Please write something for us"></textarea>
                                        <div className="validate"></div>
                                    </div>
                                    <div className="mb-3">
